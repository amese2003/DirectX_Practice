#include "pch.h"
#include "18. TriangleTessellation.h"
#include "Camera.h"
#include "CameraScript.h"
#include "Waves.h"

void TriangleTessellation::Init()
{
...

	{
		shared_ptr<Shader> shader = make_shared<Shader>();
		{
			...
			shader->Init(L"..\\Shaders\\16. TriTessellation.fx", info, args);;
		}
...
void TriangleTessellation::Update()
{


}

void TriangleTessellation::Render()
{
}