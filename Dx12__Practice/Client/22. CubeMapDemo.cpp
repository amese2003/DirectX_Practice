...
void CubeMapDemo::OnKeyboardInput()
{
...
void CubeMapDemo::AnimateMaterials()
{
}

void CubeMapDemo::UpdateObjectConstant()
{
...
void CubeMapDemo::UpdateMaterialBuffer()
{
...
void CubeMapDemo::UpdateMainPassCB()
{
...
CubeMapDemo::CubeMapDemo(HINSTANCE hInstance) : GameApp(hInstance)
{
}
...
void CubeMapDemo::BuildRootSignature()
{
...
void CubeMapDemo::BuildDescriptorHeaps()
{
...
void CubeMapDemo::BuildShadersAndInputLayout()
{
...
void CubeMapDemo::BuildMeshGeometry()
{
...
void CubeMapDemo::BuildCarGeometry()
{
...
void CubeMapDemo::BuildSkullGeometry()
{
...
void CubeMapDemo::BuildMaterials()
{
...
void CubeMapDemo::BuildRenderItems()
{
...
void CubeMapDemo::BuildFrameResources()
{
...
void CubeMapDemo::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<shared_ptr<RenderObject>>& ritems)
{
...
std::array<const CD3DX12_STATIC_SAMPLER_DESC, 6> CubeMapDemo::GetStaticSamplers()
{
